...
class dUnzip2
{
        ...
        if (sizeof($lista))
            foreach ($lista as $fileName => $trash) {
                ...
                if (substr($fileName, -1, 1) == "/")
                    continue;
                $maintainStructure ? $this->unzip($fileName, "$targetDir/$fileName", 0755) : $this->unzip($fileName, "$targetDir/" . basename($fileName), 0755);
            }
    }
    Function close()
    {
    ...
    {
        $from = "\xb7\xb5\xb6\xc7\x8e\x8f\x92\x80\xd4\x90\xd2\xd3\xde\xd6\xd7\xd8\xd1\xa5\xe3\xe0" . "\xe2\xe5\x99\x9d\xeb\xe9\xea\x9a\xed\xe8\xe1\x85\xa0\x83\xc6\x84\x86\x91\x87\x8a" . "\x82\x88\x89\x8d\xa1\x8c\x8b\xd0\xa4\x95\xa2\x93\xe4\x94\x9b\x97\xa3\x96\xec\xe7" . "\x98Ô";
