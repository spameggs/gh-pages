		...
		<tr>
			<td valign="top">
				...
				<li>
					...
					<a class="category" title="{$cat.name}" href="{$rlBase}{if $config.mod_rewrite}{$pageInfo.Path}/{$cat.Path}{if $listing_type.Cat_postfix}.html{else}/{/if}{else}?page={$pageInfo.Path}&amp;category={$cat.ID}{/if}">{$cat.name}</a>
