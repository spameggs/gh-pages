...
<div id="fileupload">
	<form action="{$smarty.const.RL_LIBS_URL|replace:$smarty.const.RL_URL_HOME:$smarty.const.RL_MOBILE_HOME}upload/account.php" method="post" enctype="multipart/form-data">
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
	<span {/literal}style="height: {$config.pg_upload_thumbnail_height+10}px;"{literal} class="template-upload fade item active">
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
	<span {/literal}style="height: {$config.pg_upload_thumbnail_height+10}px;"{literal} class="template-download fade item active">
...
var crop_handler = function(){literal}{}{/literal};
</script>
