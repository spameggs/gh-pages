...
{if $smarty.cookies.content_accepted}
	{if ($search_forms && $pageInfo.Key == 'home') || (($search_form || ($listing_type.Random_featured && $random_featured)) && (!$category.ID || $single_category_mode) && $pageInfo.Controller == 'listing_type')}
		{php}
			global $blocks;
			$blocks['right'] = true;
		{/php}
