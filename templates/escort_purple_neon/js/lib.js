...
var transformToList = function(index){
	...
	$(item).find('div.item').find('table>tbody>tr:first>td:last>table tr td:last').html($(item).find('div.item').find('table>tbody>tr:eq(2)>td').html());
