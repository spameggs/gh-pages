...
if (isset($_GET['action'])) {
    if ($_GET['action'] == 'add' || $_GET['action'] == 'edit') {
        $bcAStep[0] = array(
            'name' => $_GET['action'] == 'add' ? $lang['paygc_add_item'] : $lang['paygc_edit_item']
        );
        $id         = (int) $_GET['item'];
        ...
        if (isset($_GET['item'])) {
            $credits_manager        = $rlDb->fetch('*', array(
                'ID' => $id
            ), null, null, 'credits_manager', 'row');
        ...
        if ($_GET['action'] == 'edit' && !$_POST['fromPost']) {
            ...
            $names            = $rlDb->fetch(array(
                ...
                'Key' => 'credits_manager+name+' . $credits_manager['Key']
