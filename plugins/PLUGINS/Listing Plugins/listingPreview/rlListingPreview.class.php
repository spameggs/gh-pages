...
class rlListingPreview extends reefless
{
    function step()
    {
        global $rlDb, $listing_id, $rlSmarty, $rlHook, $rlXajax, $lang, $config, $rlLang, $reefless, $rlListings, $rlAccount, $rlListingTypes, $page_info, $listing_data, $next_step, $category;
