...
if (isset($_GET['action'])) {
    ...
    $bcAStep[] = array(
        'name' => $_GET['action'] == 'add' ? $lang['vc_add_item'] : $lang['vc_edit_item']
    );
    if ($_GET['action'] == 'add' || $_GET['action'] == 'edit') {
        ...
        if (isset($_GET['item']) && !$_POST['fromPost']) {
            $verification_code = $rlDb->fetch('*', array(
                'ID' => $id
            ), null, null, 'verification_code', 'row');
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!empty($errors)) {
                ...
                if ($_GET['action'] == 'add') {
                    ...
                    if ($action = $rlActions->insertOne($data, 'verification_code', array(
                        'Content'
                    ))) {
