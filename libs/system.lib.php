...
$l_timezone          = array(
    ...
    'America/New_York' => array(
        '-5:00',
        '(GMT -5:00) Eastern Time (US &amp; Canada), New York, Bogota, Lima'
    ),
    'America/Caracas' => array(
        '-4:30',
        '(GMT -4:30) Atlantic Time (Canada), Caracas'
    ),
    'America/Halifax' => array(
        '-4:00',
        '(GMT -4:00) Atlantic Time (Canada), La Paz, Halifax'
    ),
    ...
    'Asia/Dhaka' => array(
        '+6:00',
        '(GMT +6:00) Almaty, Dhaka, Novosibirsk'
    ),
    'Asia/Krasnoyarsk' => array(
        '+7:00',
        '(GMT +7:00) Bangkok, Hanoi, Jakarta, Krasnoyarsk'
    ),
    'Asia/Brunei' => array(
        '+8:00',
